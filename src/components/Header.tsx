export default function Header() {
  return (
    ...
    >
      <div id="header-menu" className="calypso-menu calypso-menu--stick calypso-menu--display-always ">
        <div className="calypso-menu__background"></div>
        <div className="calypso-menu__inner container">
          <div id="header-group-left" className="calypso-menu__group calypso-menu__group--1">
            <div className="calypso-menu__item calypso-menu__item--logo">
              <div id="header-logo" className="calypso-menu__logo">
            ...
            >
              <a href="/sell" className="calypso-menu__link">销售</a>
            </div>
            <div id="header-nav-promote" className="calypso-menu__item">
              <a href="/promote" className="calypso-menu__link">推广</a>
            </div>
            <div id="header-nav-manage" className="calypso-menu__item">
              <a href="/manage" className="calypso-menu__link">管理</a>
            </div>
          </div>
          <div id="header-group-right" className="calypso-menu__group calypso-menu__group--2">
            <div id="header-login-item" className="calypso-menu__item calypso-menu__item--login hpc-nav__item--login">
              <a href="https://my.ecwid.com/cp/" className="calypso-menu__link">登录</a>
            </div>
            <div id="header-cta-item" className="calypso-menu__item calypso-menu__item--cta">
              <div id="header-cta-btn-wrap" className="calypso-menu__button">
                <a
          ...
          <div id="header-dropdown" className="calypso-menu__dropdown calypso-menu__dropdown--hidden">
            <div id="header-dropdown-overflow" className="calypso-menu__dropdown-overflow">
              <div id="header-dropdown-container" className="calypso-menu__dropdown-container">
                <div id="header-dd-sell" className="calypso-menu__dropdown-item calypso-menu__dropdown-item--item-0">
                  <div id="header-dd-sell-headline" className="calypso-menu__dropdown-headline">
                    <a className="btn-link btn-link--active" href="/sell">
                      <span className="btn-link__content">销售</span>
                    </a>
                  </div>
                  <div id="header-dd-menu" className="calypso-menu__dropdown-menu">
                    <div id="header-dd-facebook" className="calypso-menu__dropdown-menu-item">
          ...
          <div id="header-mobile-group" className="calypso-menu__group calypso-menu__group--mobile">
            <div id="header-mobile-login-item" className="calypso-menu__item calypso-menu__item--login">
              <div id="header-mobile-login-btn" className="calypso-menu__button">
                <a
                  href="https://my.ecwid.com/cp/#register"
            ...
            <div id="header-mobile-cta-item" className="calypso-menu__item calypso-menu__item--cta">
              <div id="header-mobile-cta-btn" className="calypso-menu__button">
                <a
            ...
            <div id="header-mobile-burger-item" className="calypso-menu__item calypso-menu__item--mobile">
              <div id="header-burger" className="calypso-menu__burger">
                <div id="header-burger-box" className="calypso-menu__burger-box">
                  <div id="header-burger-inner" className="calypso-menu__burger-inner"></div>
                </div>
              </div>
            </div>
            <div id="header-mobile-menu" className="calypso-menu__mobile">
              <div id="header-mobile-menu-container" className="calypso-menu__mobile-container">
                ...
                <div id="header-mobile-buttons" className="btn-block text-center calypso-menu__mobile-buttons hpc-nav-disable-cta__display-none">
                  <a
                    href="https://my.ecwid.com/cp/#register"
                  ...
                  <div id="header-mobile-login-link" className="calypso-menu__mobile-login">
