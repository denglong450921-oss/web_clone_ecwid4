export default function Footer() {
  return (
    <div id="footer-main" className="calypso-page footer notranslate">
      <section id="footer-section" className="calypso-block calypso-block--b0">
        <div id="footer-container" className="container footer-menu">
          <div id="footer-row-links" className="row">
            <div id="footer-col-logo" className="col-12 col-md-2">
            ...
            <div id="footer-col-sell" className="col-12 col-md-2">
              ...
              <ul>
                ...
                <li>
                  <a href="/facebook">在 Facebook 上销售</a>
                </li>
              </ul>
            </div>
          </div>
          <div className="row">
            <div className="col-12 offset-md-2 col-md-5 col-lg-3">
              <div className="footer-menu__search">
                <form
                  ...
                  action="/search"
                >
                  <div id="footer-search-box" className="blog-search-box__container">
                    <input
                      type="text"
                ...
                <div id="footer-search-loader" className="footer-menu__search-loader">
                  <svg
                    xmlSpace="preserve"
            ...
            <div id="footer-col-social" className="col-12 offset-lg-2 col-md-5">
          ...
          <div id="footer-row-copyright" className="row footer-menu__copyright">
            <div id="footer-copyright-wrap" className="col-12 footer-menu__copyright-wrap">
              <span className="footer-menu__copy">
                &copy; 2026 Ecwid by Lightspeed
              </span>
